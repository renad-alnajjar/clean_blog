...
<body>
    ...
    <div class="page-wrapper">
        ...
        <header class="main-header">
                ...
                <div class="inner-container">
                    <div class="auto-container clearfix">
                        ...
                        <div class="logo-outer">
                            <div class="logo"><a href="index.html"><img src="{{asset('assets/front/images/logo.png')}}" alt="" title=""></a></div>
                        </div>
            ...
            <div class="sticky-header">
                <div class="auto-container clearfix">
                    ...
                    <div class="logo pull-left">
                        <a href="index.html" class="img-responsive"><img src="{{asset('assets/front/images/logo-small.png')}}" alt=""
                                title=""></a>
                    </div>
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    <div class="nav-logo"><a href="index.html"><img src="{{asset('assets/front/images/nav-logo.png')}}" alt="" title=""></a></div>
							...
							<div class="row clearfix">
								...
								<div class="footer-column col-lg-7 col-md-6 col-sm-12">
									<div class="footer-widget logo-widget">
										<div class="logo">
											<a href="index.html"><img src="{{asset('assets/front/images/footer-logo.png')}}" alt="" /></a>
										</div>
									...
									<div class="footer-widget news-widget">
										...
										<div class="news-widget-block">
											<div class="widget-inner">
												<div class="image">
													<img src="{{asset('assets/front/images/resource/news-image-1.jpg')}}" alt="" />
												</div>
										...
										<div class="news-widget-block">
											<div class="widget-inner">
												<div class="image">
													<img src="{{asset('assets/front/images/resource/news-image-2.jpg')}}" alt="" />
												</div>
    ...
    <div class="color-palate">
        ...
        <div class="various-color clearfix">
            <div class="colors-list">
                <span class="palate default-color active" data-theme-file="{{asset('assets/front/css/color-themes/default-theme.css')}}"></span>
                <span class="palate green-color" data-theme-file="{{asset('assets/front/css/color-themes/green-theme.css')}}"></span>
                <span class="palate olive-color" data-theme-file="{{asset('assets/front/css/color-themes/olive-theme.css')}}"></span>
                <span class="palate orange-color" data-theme-file="{{asset('assets/front/css/color-themes/orange-theme.css')}}"></span>
                <span class="palate purple-color" data-theme-file="c{{asset('assets/front/ss/color-themes/purple-theme.css')}}"></span>
                <span class="palate teal-color" data-theme-file="{{asset('assets/front/css/color-themes/teal-theme.css')}}"></span>
                <span class="palate brown-color" data-theme-file="{{asset('assets/front/css/color-themes/brown-theme.css')}}"></span>
                <span class="palate redd-color" data-theme-file="{{asset('assets/front/css/color-themes/redd-color.css')}}"></span>
            </div>
        </div>
    ...
    <script src="{{asset('assets/front/js/jquery.paroller.min.js')}}"></script>
